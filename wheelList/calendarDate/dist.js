...
var CalendarDate = function () {
  ...
  _createClass(CalendarDate, [{
    ...
    key: 'justLeft',
    value: function justLeft(date, left, right) {
      left.innerHTML = '';
    ...
    key: 'selectYear',
    value: function selectYear(date, left, right) {
    ...
    key: 'selectMonth',
    value: function selectMonth(date, left, right) {
      var that = this;
    ...
    key: 'justRight',
    value: function justRight(date, right, left, animate) {
      right.innerHTML = '';
      var that = this;
      // 上方控制
    ...
    key: 'dateTable',
    value: function dateTable(right, date, left, animate) {
      var that = this;
